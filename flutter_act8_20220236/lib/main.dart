...
final _products = [
  Product(name: "Hot-Cakes", price: 10),
  Product(name: "Pizza", price: 12),
  Product(name: "Hot-Dog", price: 7),
  Product(name: "Fried Chiken", price: 9),
  Product(name: "Cheesecake", price: 3),
];
